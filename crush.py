...
e = Entry(PageOne, textvariable=number, width=15, font=dfont)
...
Button(PageOne, text='Enter', font=dfont, command=number_e, height=2, width=5).grid(row=6, column=1)
Button(PageOne, text='Cancel', font=dfont, command=cancel, height=2, width=5).grid(row=6, column=2)
